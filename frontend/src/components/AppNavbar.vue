  ...
  <header class="sticky top-0 z-50 backdrop-blur border-b border-white/10 bg-black/30">
    <nav class="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
      ...
      <div class="hidden md:flex items-center gap-6">
        ...
        <RouterLink class="navlink font-bold text-[#00A651]" to="/reports">Reports</RouterLink>
      ...
      <div class="hidden md:flex items-center gap-3">
        ...
        <button class="k-btn k-accent-bg text-black" @click="openContact">Contact</button>
      </div>
    ...
    <div v-if="open" class="md:hidden border-t border-white/10 bg-black/60">
      <div class="max-w-6xl mx-auto px-4 py-3 flex flex-col gap-3">
        ...
        <RouterLink class="navlink" @click="open=false" to="/reports">Reports</RouterLink>
        ...
        <div class="flex items-center gap-3 pt-2">
          ...
          <button class="k-btn k-accent-bg text-black" @click="() => { open=false; openContact() }">Contact</button>
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="absolute left-1/2 top-1/2 w-[92%] max-w-md -translate-x-1/2 -translate-y-1/2">
      <div class="k-card p-6 shadow-2xl">
        <div class="flex items-start justify-between">
          <div>
            <h3 class="text-xl font-bold">Contact <span class="k-accent">Kyriq</span></h3>
            <p class="mt-2 text-sm opacity-80">Email me and I’ll get back to you.</p>
          </div>
        ...
        <div class="mt-4 rounded-xl bg-white/5 p-4">
          ...
          <div class="mt-1 font-mono text-sm">kecole2@cougarnet.uh.edu</div>
        </div>
        <div class="mt-5 flex gap-3">
          <a href="mailto:kecole2@cougarnet.uh.edu" class="flex-1 text-center px-4 py-2 rounded-xl k-accent-bg text-black font-semibold">Open Email</a>
...
<style scoped>
.navlink { opacity: 0.88; transition: opacity 0.2s; }
